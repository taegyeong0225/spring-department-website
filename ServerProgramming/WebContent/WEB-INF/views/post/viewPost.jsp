...
<div class="container mt-5">
    <div class="row">
        ...
        <div class="card-footer text-right">
            ...
            <a href="${pageContext.request.contextPath}/editPost?boardId=${boardDataBean.boardId}&category=${boardDataBean.category}" class="btn btn-primary btn-sm">수정</a>
            <a href="${pageContext.request.contextPath}/deletePost?boardId=${boardDataBean.boardId}&category=${boardDataBean.category}" class="btn btn-danger btn-sm">삭제</a>
        </div>
    </div>
</div>
